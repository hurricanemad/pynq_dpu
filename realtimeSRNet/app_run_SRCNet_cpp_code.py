# Author: Dox
# date:   16 Jun 2024
# Introduction: This program can capture the realtime video stream of webcam and upscale the video stream to 2 times sizes.
...
# base folder
base_dir = "/root/jupyter_notebooks/pynq-dpu/realtimeSRNet"

# relative folders
executable      = "realtimeSRNet"
xmodel_file     = "SRCNN_255_pt/SRCNN_pt.xmodel"
camera_id = "0"
logfile         = "cpp_SRCNN_predictions.log"
